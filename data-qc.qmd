...
site_sel <- "f_Rotorua"
site <- read_csv("data-raw/site.csv", col_types = cols())
...
```{r}
# ggplot() +
#   geom_scattermore(data = raw, aes(x = datetime, y = f_chl_d100)) +
#   coord_cartesian(ylim = c(0, 500)) +
#   theme_bw()
```
...
chla_corr <- raw_v |>
  update_qc_code_vectorized(qc_update_df = chl_adj) |>
...
# viz_data(data = chla_corr, site_events = site_events, variable = "var_ref_id",
#          value = "qc_value")

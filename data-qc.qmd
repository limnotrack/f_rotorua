...
fluorescence, phycocyanin fluorescence, pH, or meteorological data. We have 
therefore adapted the NEMS quality control codes to include these sensors, using 
similar checks and adjustments described in the 
...
Phycocyanin fluorescence sensors currently do not have a NEMS classification. 
We have therefore adapted the NEMS quality control codes to include these 
sensors, using similar checks and adjustments described in the 
[Processing of Environmental Time-series Data](https://www.nems.org.nz/documents/data-processing) 
(v1.2.0, August 2024) document.
...
pH sensors currently do not have a NEMS classification. 
We have therefore adapted the NEMS quality control codes to include these 
sensors, using similar checks and adjustments described in the 
[Processing of Environmental Time-series Data](https://www.nems.org.nz/documents/data-processing) 
(v1.2.0, August 2024) document.
